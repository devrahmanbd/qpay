...
class Model extends BaseModel
{
    ...
    {
        $email_from = get_option('email_from', '') ?: "support@rentalpanelbd.com";
        $email_name = get_option('email_name', '') ?: get_option('site_title', '');

        $website_link = base_url();
        $website_logo = base_url(get_option('site_logo', "assets/images/logo.png"));
        $website_name = get_option("site_name", "YOUR SITE");
        ...
        if ($user_type == 'general') {
            ...
            $where = "id = '$user_id_or_email' OR email = '$user_id_or_email'";
            $user_info = $this->get("*", 'users', $where);
            if (empty($user_info)) {
            ...
            $where = "id = '$user_id_or_email' OR email = '$user_id_or_email'";
            $user_info = $this->get("*", 'staffs', $where);
            if (empty($user_info)) {
