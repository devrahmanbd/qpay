...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-5">
  <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
    ...
    <div>
      ...
      <input type="text" value="<?=$items['domain']?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm bg-gray-50" readonly>
    </div>
    <div>
  ...
  <div>
    <label class="block text-sm font-medium text-gray-700 mb-1">Invoice URL</label>
