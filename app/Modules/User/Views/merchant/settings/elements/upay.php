...
$account_types = [
    ...
    'merchant' => ['name' => 'Merchant', 'icon' => 'fa-briefcase', 'desc' => 'Upay Business API']
];
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-gray-50/50 border border-gray-100 p-4 rounded-xl">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium text-gray-700">Enable Upay</span>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 lg:p-8 shadow-sm">
                ...
                <div x-show="['personal', 'agent'].includes(activeType)" x-cloak class="space-y-6">
                    <div x-show="activeType === 'personal'">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Upay Personal Number</label>
                        <div class="relative">
                    ...
                    <div x-show="activeType === 'agent'">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">Upay Agent Number</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                ...
                <div x-show="activeType === 'merchant'" x-cloak class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="merchant_id" value="<?= @get_value($params, 'merchant_id') ?>" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all" placeholder="Merchant ID">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Merchant Key</label>
                            <input type="text" name="merchant_key" value="<?= @get_value($params, 'merchant_key') ?>" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all" placeholder="Merchant Key">
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Merchant Code</label>
                            <input type="text" name="merchant_code" value="<?= @get_value($params, 'merchant_code') ?>" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all" placeholder="Merchant Code">
                        </div>
                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Merchant Name</label>
                            <input type="text" name="merchant_name" value="<?= @get_value($params, 'merchant_name') ?>" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all" placeholder="Business Name">
                        </div>
                    </div>
                </div>
