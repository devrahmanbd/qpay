...
$account_types = [
    ...
    'merchant' => ['name' => 'Merchant', 'icon' => 'fa-briefcase', 'desc' => 'OK Wallet Business']
];
?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-gray-50/50 border border-gray-100 p-4 rounded-xl">
                ...
                <div class="flex items-center justify-between">
                    <span class="text-sm font-medium text-gray-700">Enable OK Wallet</span>
            ...
            <div class="bg-white border border-gray-100 rounded-2xl p-6 lg:p-8 shadow-sm">
                ...
                <div x-show="['personal', 'agent'].includes(activeType)" x-cloak class="space-y-6">
                    <div x-show="activeType === 'personal'">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">OK Wallet Personal Number</label>
                        <div class="relative">
                    ...
                    <div x-show="activeType === 'agent'">
                        <label class="block text-sm font-semibold text-gray-700 mb-2">OK Wallet Agent Number</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                ...
                <div x-show="activeType === 'merchant'" x-cloak class="space-y-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-700 mb-2">OK Wallet Merchant Payment URL</label>
                        <div class="relative">
                            <span class="absolute inset-y-0 left-0 flex items-center pl-3 text-gray-400">
                                <i class="fas fa-link"></i>
                            </span>
                            <input type="text" name="merchant_url" value="<?= @get_value($params, 'merchant_url') ?>" class="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all" placeholder="https://payment.okwallet.com/...">
                        </div>
                        <p class="text-xs text-gray-500 mt-2 italic">Note: Use this if you have a custom payment portal URL for OK Wallet.</p>
                    </div>
                </div>
