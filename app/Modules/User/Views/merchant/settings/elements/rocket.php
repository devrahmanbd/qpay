  ...
  <div class="">
    <div class="">
      ...
      <div id="personal<?= $brand->id ?>" class="type-class">
        ...
        <input type="text" name="personal_number" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none" value="<?= @get_value($payment_settings->params, 'personal_number') ?>" placeholder="Enter your Rocket number">
      </div>
      ...
      <div id="merchant<?= $brand->id ?>" class="type-class d-none">
        ...
        <input type="text" name="merchant_url" value="<?= @get_value($payment_settings->params, 'merchant_url') ?>" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none" placeholder="Rocket Payment URL">
      </div>
