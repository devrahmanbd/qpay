...
<div class="content">
  <div class="px-4 py-3 border-b border-gray-100">
    <h3 class="text-base font-semibold text-gray-800"><i class="fa-brands fa-square-reddit"></i> <?=lang("Payeer Setup for-".$brand->brand_name)?></h3>
  </div>
  <div class="">
    <div class="">
          ...
          <div class="form-group mb-2">
            <label class="form-label">Webhook URL</label>
              <div class="input-group">
                <input readonly type="text" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-to-cliboard" value="<?=site_config('payment_url').'/callback/payeer';?>" >
