...
INSERT INTO `api_keys` VALUES (5,8,1,'WooCommerce Test','publishable','pk_test_','bb3cbe45307642d6eb9923923cf619cbb8f882552a93d7514ff85d490e9cd774','00dd','test',NULL,NULL,'2026-04-19 22:10:16','2026-04-19 09:29:10'),(6,8,1,'WooCommerce Test','secret','qp_test_','247b059cf234f695927780aad7c58f07cb860af249b1556ae577ddb3770fb181','162a','test','2026-04-19 09:29:10',NULL,'2026-04-19 22:10:19','2026-04-19 09:29:10'),(7,8,1,'Default','publishable','pk_live_','4b087824709430ce5e9dec831fb87d407f71a0b6684ae83c63f71c83d12df89d','9163','live',NULL,NULL,'2026-04-20 10:32:25','2026-04-20 10:10:36'),(8,8,1,'Default','secret','qp_live_','35fb1ea4e89a51115d9ee79b98cb87e278a7fcb9f7dc9d71c95547124b820eb0','ec13','live',NULL,NULL,'2026-04-20 10:32:29','2026-04-20 10:10:37');
...
INSERT INTO `devices` VALUES (14,1,'admin@cloudman.one','Relme8','fVSARTobNKvglddV9QhKlPFTsFcLUD884mmh1wjg',NULL,NULL,NULL,'2025-03-11 20:15:22',NULL,NULL);
...
INSERT INTO `migrations` VALUES (1,'2023-12-23-055313','Modules\\Blocks\\Database\\Migrations\\Queue','default','Blocks',1733164861,1),(2,'2023-12-23-055313','Modules\\Home\\Database\\Migrations\\Settings','default','Home',1733164862,2),(3,'2023-12-26-040632','Modules\\Home\\Database\\Migrations\\FileManager','default','Home',1733164862,2),(4,'2023-12-27-012628','Modules\\Home\\Database\\Migrations\\Payments','default','Home',1733164862,2),(5,'2024-04-30-042916','Modules\\Home\\Database\\Migrations\\Blogs','default','Home',1733164862,2),(6,'2024-05-15-153103','Modules\\Home\\Database\\Migrations\\Addons','default','Home',1733164862,2),(7,'2026-03-17-100000','App\\Database\\Migrations\\CreateApiKeysTable','default','App',1776636004,3),(8,'2026-03-17-100001','App\\Database\\Migrations\\CreateWebhooksTables','default','App',1776636004,3),(9,'2026-03-17-100002','App\\Database\\Migrations\\CreateApiLogsTable','default','App',1776636004,3),(10,'2026-03-17-100003','App\\Database\\Migrations\\AddTestModeToApiPayments','default','App',1776636039,4),(11,'2026-04-20-000001','App\\Database\\Migrations\\AddHeartbeatToDevices','default','App',1776636083,5);
...
CREATE TABLE `module_data` (
  `id` int unsigned NOT NULL AUTO_INCREMENT,
  `tmp_id` varchar(100) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `uid` int unsigned NOT NULL,
  ...
  KEY `idx_uid_status_address` (`uid`,`status`,`address`),
...
INSERT INTO `webhook_events` VALUES (3,3,'payment.created','{\"data\": {\"id\": \"test_pay_1776563332\", \"amount\": 10, \"status\": \"processing\", \"currency\": \"BDT\", \"test_mode\": true}, \"event\": \"payment.created\", \"created\": 1776563332}','pending',1,'2026-04-19 07:48:54',401,'{\"error\":\"Invalid signature\"}','2026-04-19 07:49:54','2026-04-19 07:48:52'),(4,3,'payment.created','{\"data\": {\"id\": \"test_pay_1776564216\", \"amount\": 10, \"status\": \"processing\", \"currency\": \"BDT\", \"test_mode\": true}, \"event\": \"payment.created\", \"created\": 1776564216}','pending',1,'2026-04-19 08:03:37',401,'{\"error\":\"Invalid signature\"}','2026-04-19 08:04:37','2026-04-19 08:03:36'),(5,3,'payment.created','{\"data\": {\"id\": \"test_pay_1776564448\", \"amount\": 10, \"status\": \"processing\", \"currency\": \"BDT\", \"test_mode\": true}, \"event\": \"payment.created\", \"created\": 1776564448}','pending',1,'2026-04-19 08:07:29',401,'{\"error\":\"Invalid signature\"}','2026-04-19 08:08:29','2026-04-19 08:07:28');
...
INSERT INTO `webhooks` VALUES (4,8,1,'https://microscrop.shop/index.php/wp-json/qpay/v1/webhook','whsec_f4194b201aba221778d10b6abaa97c39966d1799d6cd42ce','[\"*\", \"payment.created\", \"payment.completed\", \"payment.failed\", \"refund.created\"]',1,NULL,'2026-04-20 10:11:03','2026-04-20 10:11:03',NULL);
...
-- Dump completed on 2026-04-20 22:36:05
