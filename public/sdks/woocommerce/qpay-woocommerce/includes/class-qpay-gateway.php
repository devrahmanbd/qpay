    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = [
            ...
            'test_secret_key' => [
                ...
                'type' => 'password',
                'description' => 'Your QPay test secret key (starts with <code>qp_test_</code>).',
                'default' => '',
            ],
            'test_publishable_key' => [
                'title' => 'Test Publishable Key',
                'type' => 'password',
                'description' => 'Your QPay test publishable key (starts with <code>pk_test_</code>).',
                'default' => '',
            ],
            'live_secret_key' => [
                'title' => 'Live Secret Key',
                'type' => 'password',
                'description' => 'Your QPay live secret key (starts with <code>qp_live_</code>).',
                'default' => '',
            ],
            'live_publishable_key' => [
                'title' => 'Live Publishable Key',
                'type' => 'password',
                'description' => 'Your QPay live publishable key (starts with <code>pk_live_</code>).',
                'default' => '',
            ],
            'webhook_secret' => [
